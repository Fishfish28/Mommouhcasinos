...
function _m(){
  ...
  [hasEntered,setHasEntered]=T.useState(false),
  [isEntranceAnimating,setIsEntranceAnimating]=T.useState(false),
  [n,r]=T.useState(""),
  ...
  const isMainPageRevealed=!geoState.loading && !geoState.isHungary && ageVerified;

  T.useEffect(()=>{
    if(isMainPageRevealed && !hasEntered){
      setHasEntered(true);
  ...
  },[isMainPageRevealed,hasEntered]);

  return a.jsxs("div",{
    className:isEntranceAnimating?"hub-entrance":"",
    children:[
      a.jsx(Xp,{}),
      ...
      a.jsxs("div",{
        ...
        children:[
          a.jsx("div",{className:"hidden lg:block hub-anim-sidebar",children:a.jsx(Oo,{activeSection:e,onSelect:f,adminUnlocked:o})}),
